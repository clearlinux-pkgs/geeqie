...
Source0  : https://github.com/BestImageViewer/geeqie/releases/download/v2.5/geeqie-2.5.tar.xz
Source1  : https://github.com/BestImageViewer/geeqie/releases/download/v2.5/geeqie-2.5.tar.xz.asc
...
%setup -q -n geeqie-2.5
cd %{_builddir}/geeqie-2.5
pushd ..
cp -a geeqie-2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727190383
...
/usr/lib/geeqie/geeqie-exif-datetime-to-file
...
/usr/share/bash-completion/completions/geeqie
/usr/share/geeqie/applications/org.geeqie.camera-import.desktop
/usr/share/geeqie/applications/org.geeqie.exif-datetime-to-file.desktop
