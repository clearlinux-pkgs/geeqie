...
Source0  : https://github.com/BestImageViewer/geeqie/releases/download/v2.1/geeqie-2.1.tar.xz
Source1  : https://github.com/BestImageViewer/geeqie/releases/download/v2.1/geeqie-2.1.tar.xz.asc
...
%prep
%setup -q -n geeqie-2.1
cd %{_builddir}/geeqie-2.1
pushd ..
cp -a geeqie-2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698792233
...
ninja -v -C builddir
CFLAGS="$CFLAGS -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 -O3" CXXFLAGS="$CXXFLAGS -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -m64 -march=x86-64-v3" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Djpegxl=disabled \
